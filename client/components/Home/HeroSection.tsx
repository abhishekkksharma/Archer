...
function HeroSection() {
  ...
  `,
      ...
      className="flex w-full h-150 pt-30 lg:pt-0 items-start lg:items-center lg:min-h-screen px-6 pb-20 md:px-12 lg:px-20"
    ...
    >
      ...
      `}</style>
      <div className="grid w-full grid-cols-1 items-center md:grid-cols-2 gap-12 md:gap-16 lg:gap-24">
        {/* Left */}
        <div >
